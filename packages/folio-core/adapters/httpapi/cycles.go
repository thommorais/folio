...
func (h *Handler) listCycles(e *core.RequestEvent) error {
	cycles, err := h.cycles.ListCycles(e.Request.Context(), actorOf(e), domain.TicketID(e.Request.PathValue("ticket")))
	if err != nil {
		return fail(e, err)
	}
...
func (h *Handler) openCycle(e *core.RequestEvent) error {
	cycle, err := h.cycles.OpenCycle(e.Request.Context(), actorOf(e), domain.TicketID(e.Request.PathValue("ticket")))
	if err != nil {
		return fail(e, err)
	}
