...
type CycleUseCase interface {
	...
	CurrentCycle(ctx context.Context, actor Actor, issue domain.IssueID) (domain.Cycle, error)
	NextPhase(ctx context.Context, actor Actor, id domain.CycleID) (domain.Cycle, error)
}
