...
// The fields tickets, plans and todos all sort by, so the work view can order
// its three columns from one control.
export const WORK_SORT_FIELDS = ['title', 'status', 'created', 'updated'] as const
